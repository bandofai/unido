...
echo -e "  ${GREEN}cd node_modules/@modelcontextprotocol/inspector/cli${NC}"
echo -e "  ${GREEN}node build/index.js http://localhost:3000/sse --transport sse --method tools/list${NC}"
echo -e ""
